...
int main(int argc, char* argv[])
{
    help();
    Settings s;
<<<<<<< Updated upstream:resources/CameraCalibrator/Src/CameraCalibrator.cpp
...
>>>>>>> Stashed changes:resources/CameraCalibrator/src/CameraCalibrator.cpp
    ...
    if (imageFilePath != "")
      s.input = imageFilePath;
    s.outputFileName = robotName;
    s.interprate();
    if (!s.goodInput)
    {
    ...
    for(int i = 0;;++i)
    {
      ...
      if(view.empty())          // If no more images then run calibration, save and stop loop.
      {
        ...
        if (imageSize.width < 480) {
          ...
          cv::addWeighted(inputImage, 1.5, dst, -0.5, 0, dst);
          inputImage = dst;
          resized = true;
        } else {
          inputImage = view;
        ...
        case Settings::CHESSBOARD:
            found = findChessboardCorners(inputImage, s.boardSize, pointBuf,
                ...
                if( s.calibrationPattern == Settings::CHESSBOARD)
                {
                  Size thres = Size(11,11);
                   if (resized) {
                    ...
                    cornerSubPix( viewGray, pointBuf, thres,
