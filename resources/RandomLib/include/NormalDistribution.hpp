  ...
  template<typename RealType = double>
    ...
    public:
      ...
      template<class Random>
        RealType
        operator()(Random& r, RealType mu = RealType(0), RealType sigma =
          RealType(1)) const throw ();
    };
  ...
  template<typename RealType>
    template<class Random>
        ...
        RealType sigma) const throw ()
      {
        ...
        const RealType m = RealType(1.7156), // sqrt(8/e) (rounded up)
        s = RealType(0.449871), // Constants from Leva
        t = RealType(-0.386595), a = RealType(0.19600), b = RealType(0.25472),
          r1 = RealType(0.27597), r2 = RealType(0.27846);
        RealType u, v, Q;
