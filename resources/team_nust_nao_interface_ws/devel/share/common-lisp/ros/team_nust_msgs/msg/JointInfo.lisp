...
(cl:defmethod cl:initialize-instance :after ((m <JointInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name team_nust_msgs-msg:<JointInfo> is deprecated: use team_nust_msgs-msg:JointInfo instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <JointInfo>))
...
(cl:defmethod name-val ((m <JointInfo>))
...
(cl:defmethod stiffness-val ((m <JointInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader team_nust_msgs-msg:stiffness-val is deprecated.  Use team_nust_msgs-msg:stiffness instead.")
  (stiffness m))

(cl:ensure-generic-function 'temperature-val :lambda-list '(m))
(cl:defmethod temperature-val ((m <JointInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader team_nust_msgs-msg:temperature-val is deprecated.  Use team_nust_msgs-msg:temperature instead.")
  (temperature m))

(cl:ensure-generic-function 'current-val :lambda-list '(m))
(cl:defmethod current-val ((m <JointInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader team_nust_msgs-msg:current-val is deprecated.  Use team_nust_msgs-msg:current instead.")
  (current m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<JointInfo>)))
  ...
  (cl:format cl:nil "Header header~%string[] name~%float64[] stiffness~%float64[] temperature~%float64[] current~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'JointInfo)))
  "Returns full string definition for message of type 'JointInfo"
  (cl:format cl:nil "Header header~%string[] name~%float64[] stiffness~%float64[] temperature~%float64[] current~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
