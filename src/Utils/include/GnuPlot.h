...
public:
  ...
  template<typename X>
    Gnuplot&
    plot_x(const std::vector<X>& x, const std::string &title = "");
  ...
  template<typename X, typename Y>
    Gnuplot&
    plot_xy(const std::vector<X>& x, const std::vector<Y>& y, const std::string &title = "");
  ...
  template<typename X, typename Y, typename E>
    Gnuplot&
    plot_xy_err(const std::vector<X> &x, const std::vector<Y> &y, const std::vector<E> &dy, const std::string &title =
      "");
  ...
  template<typename X, typename Y, typename Z>
    Gnuplot&
    plot_xyz(const std::vector<X> &x, const std::vector<Y> &y, const std::vector<Z> &z, const std::string &title = "");
