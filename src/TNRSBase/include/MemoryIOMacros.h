...
#define LOLA_PERIOD_IN(Base) IVAR(int, Base::Input::lolaThreadPeriod)
...
#define LOLA_TIME_TAKEN_IN(Base) IVAR(int, Base::Input::lolaThreadTimeTaken)
...
#define LOLA_PERIOD_IN_REL(Base, BasePtr) IVAR_REL(BasePtr, int, Base::Input::lolaThreadPeriod)
...
#define LOLA_TIME_TAKEN_IN_REL(Base, BasePtr) IVAR_REL(BasePtr, int, Base::Input::lolaThreadTimeTaken)
...
#define LOLA_PERIOD_OUT(Base) OVAR(int, Base::Output::lolaThreadPeriod)
...
#define LOLA_TIME_TAKEN_OUT(Base) OVAR(int, Base::Output::lolaThreadTimeTaken)
...
#define LOLA_PERIOD_OUT_REL(Base, BasePtr) OVAR_REL(BasePtr, int, Base::Output::lolaThreadPeriod)
...
#define LOLA_TIME_TAKEN_OUT_REL(Base, BasePtr) OVAR_REL(BasePtr, int, Base::Output::lolaThreadTimeTaken)
