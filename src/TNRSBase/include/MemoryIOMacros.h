...
#define SB_PERIOD_IN(Base) IVAR(int, Base::Input::sbThreadPeriod)
...
#define SB_INFO_IN(Base) IVAR(BehaviorInfo, Base::Input::sBehaviorInfo)
...
#define SB_PERIOD_IN_REL(Base, BasePtr) IVAR_REL(BasePtr, int, Base::Input::sbThreadPeriod)
...
#define SB_INFO_IN_REL(Base, BasePtr) IVAR_REL(BasePtr, BehaviorInfo, Base::Input::sBehaviorInfo)
...
#define SB_PERIOD_OUT(Base) OVAR(int, Base::Output::sbThreadPeriod)
...
#define SB_INFO_OUT(Base) OVAR(BehaviorInfo, Base::Output::sBehaviorInfo)
...
#define SB_PERIOD_OUT_REL(Base, BasePtr) OVAR_REL(BasePtr, int, Base::Output::sbThreadPeriod)
...
#define SB_INFO_OUT_REL(Base, BasePtr) OVAR_REL(BasePtr, BehaviorInfo, Base::Output::sBehaviorInfo)
