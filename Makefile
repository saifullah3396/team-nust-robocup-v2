...
interface:
	catkin_make -C $(PATH_TO_TEAM_NUST_DIR)/resources/team_nust_nao_interface_ws -j4 -DROBOT_VERSION=$(ROBOT_VERSION) -DCATKIN_DEVEL_PREFIX=$(PATH_TO_TEAM_NUST_DIR)/build-$(ROBOT_VERSION)
